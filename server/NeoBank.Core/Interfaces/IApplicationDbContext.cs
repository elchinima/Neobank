...
public interface IApplicationDbContext
{
    ...
    DbSet<PublicPageSettingTranslation> PublicPageSettingTranslations { get; set; }
    DbSet<FooterLink> FooterLinks { get; set; }
    DbSet<FooterContact> FooterContacts { get; set; }
